...
import com.api.curse.*;
import com.api.topic.*;
import com.api.user.*;
...
public class TopicController {
    ...
    @Autowired
    private ICurso cursoRepository;
    ...
    public Topic crearTopico(@Valid @RequestBody CrearTopicRequest request) {
    ...
    public List<Topic> obtenerTopicos() {
    ...
    public Topic obtenerTopicoPorId(@PathVariable Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Topic> actualizarTopico(@PathVariable Long id, @RequestBody ActualizarTopicDTO dto) {
        Topic actualizado = topicoService.actualizarTopico(id, dto);
